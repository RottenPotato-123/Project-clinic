...
<body class="bg-gray-100 font-family-karla flex">
    <?php if (isAdmin($user_type)) { ?>
        ...
        <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
            ...
            <table id="appointment-history-table" border="1">
  <thead>
    <tr>
      <th>Client ID</th>
      <th>Client Name</th>
  ...
  <tbody>
    ...
    // Retrieve appointment history records
    $sql = "SELECT a.id, u.name, a.appointment_date, a.appointment_number, a.status
            FROM appointments a
    ...
    if ($result->num_rows > 0) {
      ...
      echo "<tr>";
      echo "<td colspan='5'>No appointment history records found.</td>";
      echo "</tr>";
    }
